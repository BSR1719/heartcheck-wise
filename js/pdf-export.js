...
.pdf-one-page-report{position:fixed;left:-10000px;top:0;width:794px;height:1123px;overflow:hidden;padding:30px 34px;background:#fff;color:#12395f;font-family:Inter,"Noto Sans Thai",Tahoma,sans-serif;line-height:1.34}.r-head{height:72px;display:flex;align-items:center;border-bottom:2px solid #d7e4ed;padding-bottom:11px}.r-head img{width:178px;height:52px;object-fit:contain;object-position:left center}.r-brand{padding-left:17px;margin-left:16px;border-left:1px solid #cbdbe7;display:flex;flex-direction:column}.r-brand b{font-size:21px;color:#0d3155}.r-brand span{font-size:12px;color:#60778d}.r-date{margin-left:auto;font-size:11px;color:#60778d;align-self:flex-start;padding-top:6px}.r-risk{margin-top:13px;display:grid;grid-template-columns:1fr 160px;gap:13px;background:linear-gradient(135deg,#eef8ff,#eefbf7);border:1px solid #d1e7ef;border-radius:18px;padding:16px 20px}.r-risk>div:first-child{display:flex;flex-direction:column}.r-risk span{font-size:13px;color:#355a78}.r-risk strong{font-size:48px;line-height:1;color:#0d3155;margin:3px 0}.r-risk b{font-size:16px;color:#0d3155}.r-risk small{font-size:9px;color:#60778d;margin-top:4px}.r-risk-side{border-left:1px solid #cbdfe8;padding-left:16px;display:flex;flex-direction:column;justify-content:center}.r-risk-side strong{font-size:29px}.r-meaning{margin-top:11px;padding:12px 14px;border:1px solid #d8e7ef;border-radius:15px;background:#fff}.r-meaning h2{font-size:16px;margin:0 0 8px;color:#0d3155}.r-meaning-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.r-meaning-grid>div{padding:9px 10px;border-radius:11px;background:#f6fafc}.r-meaning-grid b{display:block;font-size:12px;color:#0969da;margin-bottom:3px}.r-meaning-grid p{margin:0;font-size:10px;line-height:1.45;color:#355a78}.r-meaning-note{margin-top:8px;padding:7px 9px;border-radius:9px;background:#fff8e8;color:#70581a;font-size:9px;line-height:1.4}.r-grid{display:grid;grid-template-columns:1.08fr .92fr;gap:12px;margin-top:11px}.r-card{border:1px solid #d8e5ef;border-radius:15px;padding:13px 14px;background:#fff}.r-card h2,.r-actions h2{font-size:16px;margin:0 0 8px;color:#0d3155}.r-priority{display:grid;grid-template-columns:28px 1fr;gap:7px;padding:6px 0;border-top:1px solid #edf2f5}.r-priority:first-of-type{border-top:0}.r-num{width:24px;height:24px;border-radius:50%;display:grid;place-items:center;background:#e7f3ff;color:#0969da;font-weight:900;font-size:11px}.r-priority b{font-size:12px}.r-priority p{font-size:9px;color:#526b84;margin:2px 0}.r-priority small{display:block;font-size:8.5px;color:#176344}.r-plan{background:#f3fbf6;border-color:#cee7d8}.r-time{padding:7px 9px;background:#fff;border-radius:9px;margin:6px 0}.r-time b{display:block;color:#176344;font-size:11px}.r-time span{display:block;font-size:9px;color:#355a78;margin-top:2px}.r-actions{margin-top:11px;border-radius:15px;padding:12px 14px;background:#f7fbfd;border:1px solid #d8e8f2}.r-action-grid{display:grid;grid-template-columns:1fr 1fr;gap:7px}.r-action-grid div{border-radius:9px;background:#fff;padding:7px 9px}.r-action-grid b{display:block;font-size:11px;color:#0969da}.r-action-grid span{display:block;font-size:8.5px;color:#526b84;margin-top:2px}.r-discuss{margin-top:9px;padding:9px 12px;border-left:4px solid #8b65d5;border-radius:9px;background:#fbf9ff}.r-discuss b{font-size:11px}.r-discuss span{font-size:9px;color:#526b84;margin-left:7px}.r-foot{position:absolute;left:34px;right:34px;bottom:22px;border-top:1px solid #d8e5ef;padding-top:7px;color:#6c8091;font-size:7.5px}.r-foot div+div{margin-top:2px}
...
window.HeartCheckPdfExport={ensurePdfButton,downloadResultPdf,buildPdfBlob,deliverPdf,expandForPdf,ensurePdfLibraries,reportData,buildOnePageReport,riskMeaning,countRange,complementRange};
})();
