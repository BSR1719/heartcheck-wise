...
function buildOnePageReport(data){
  ...
  report.innerHTML=`
    ...
    </div><footer class="r-foot"><img class="r-foot-banner" src="${BANNER}" crossorigin="anonymous" alt="โรงพยาบาลกรุงเทพสุราษฎร์"><div><b>อ้างอิงหลัก:</b> AHA PREVENT™ Equations · ACC/AHA prevention guidance · AHA Life’s Essential 8</div><div>คำแนะนำนี้ช่วยเพิ่มความเข้าใจและเตรียมการดูแลสุขภาพ ไม่ใช่คำสั่งเริ่ม/หยุด/ปรับยา และไม่แทนการประเมินโดยแพทย์</div></footer>`;
